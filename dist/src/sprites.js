...
const grabber = sheet("grabber", "thug", {
  o: "#05060a", s: "#f2c08e", h: "#15221b", j: "#5cffbf", d: "#1c4a3e", t: "#ff4fd8", g: "#ff4fd8", b: "#161a18", l: "#baffff", a: "#5cffbf"
}, { w: 48, h: 64, scale: 2.42 });

const shield = sheet("shield", "brute", {
  o: "#05060a", s: "#e3b98e", h: "#111827", j: "#64a8ff", d: "#27446e", t: "#c7d0dd", g: "#c7d0dd", b: "#141a24", l: "#dce8ff", a: "#8fa8c8"
}, { w: 48, h: 64, scale: 2.64 });

const thrower = sheet("thrower", "thug", {
  o: "#05060a", s: "#f2c08e", h: "#2a1a09", j: "#ffd15c", d: "#7d5420", t: "#37f5ff", g: "#37f5ff", b: "#161616", l: "#fff1a3", a: "#ffd15c"
}, { w: 48, h: 64, scale: 2.34 });

const drone = sheet("drone", "blade", {
  o: "#05060a", s: "#c7d0dd", h: "#091722", j: "#37f5ff", d: "#0b6577", t: "#ffffff", g: "#baffff", b: "#111622", l: "#ffffff", a: "#37f5ff"
}, { w: 48, h: 64, scale: 2.05 });

const medic = sheet("medic", "thug", {
  o: "#05060a", s: "#f2c08e", h: "#142119", j: "#7cff70", d: "#255434", t: "#ffffff", g: "#ffffff", b: "#151515", l: "#e8ffe5", a: "#7cff70"
}, { w: 48, h: 64, scale: 2.34 });

const bomber = sheet("bomber", "thug", {
  o: "#05060a", s: "#e8b283", h: "#21110a", j: "#ff8b3d", d: "#743b1e", t: "#ffd15c", g: "#ffd15c", b: "#161616", l: "#ffe2a0", a: "#ff8b3d"
}, { w: 48, h: 64, scale: 2.36 });

const ninja = sheet("ninja", "blade", {
  o: "#05060a", s: "#d7b19a", h: "#090915", j: "#b75cff", d: "#35215b", t: "#baffff", g: "#37f5ff", b: "#11101a", l: "#f2d6ff", a: "#b75cff"
}, { w: 48, h: 64, scale: 2.34 });

const mutant = sheet("mutant", "brute", {
  o: "#05060a", s: "#acd883", h: "#152014", j: "#7cff70", d: "#285a30", t: "#ff4fd8", g: "#ff4fd8", b: "#142014", l: "#ddffbb", a: "#7cff70"
}, { w: 48, h: 64, scale: 2.86 });
...
for (const s of [thug, blade, brute, grabber, shield, thrower, drone, medic, bomber, ninja, mutant]) {
  anim(s, {
...
export const SPRITE_SHEETS = { jax, mira: rook, thug, blade, brute, grabber, shield, thrower, drone, medic, bomber, ninja, mutant, boss };
